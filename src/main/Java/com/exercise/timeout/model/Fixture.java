...
public class Fixture {
    ...
    public Fixture(List<Venue> venueList) {
        ...
        this.goVenueSet = goVenueSet;
        this.avoidVenueSet = avoidVenueSet;
        this.avoidEatMap = avoidEatMap;
        this.avoidDrinkMap = avoidDrinkMap;
    }
